...
RECOMMENDATION_GUIDANCE = (
    ...
    " - 이 이유는 반드시 **'사용자 프로필의 특정 요소/ 사용자의 질문'**와 **'공고의 요구사항'과 'title'과 직무명을 언급해서 ** 직접 연결해야 합니다. (예: '데이터베이스 과목을 수강했기 때문에, 이 공고의 SQL 역량 요구에 부합합니다.')\n"
    " - 구체적으로 사용자의 수강이력과 구체적인 과목명과 공고와 일치하는 이유를 작성하세요.\n"
    ...
    " - '프로필'을 바탕으로 사용자의 강점을 언급하고, 앞으로 무엇을 더 준비하면 좋을지 구체적인 다음 단계를 제안하세요. 구체적인 자격증명이나 어떤 포트폴리오의 주제를 하면 좋을지도 제안하면 좋아요. 일반적인 답변이 아닌 아주 구체적이게 답변하세요.   (예: '클라우드 관련 인턴을 목표로 하신다면, 지금 듣고 계신 네트워크 과목과 연계하여 AWS 자격증을 준비해보는 것을 추천합니다.')"
    " - 사용자의 특정 경험이나 활동을 더 구체적으로 언급하면 좋아요.  최대한 구체적인 제안을 추가하세요. (예: 기계공학부 동아리 활동을 통해 얻은 경험을 이력서에 강조하세요) "
)
